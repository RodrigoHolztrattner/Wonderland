...
Wvoid WMatrix4::Translation(WMatrix4& _out, WMatrix4& _in, WVector3 _position)
{
...
void WMatrix4::BuildView(WVector3 _position, WVector3 _rotation, WVector3 _lookAt, WVector3 _up)
{
	WVector3 zAxis, xAxis, yAxis;
...
void WMatrix4::BuildTransform(WVector3 _position, WVector3 _rotation, WVector3 _size)
{
