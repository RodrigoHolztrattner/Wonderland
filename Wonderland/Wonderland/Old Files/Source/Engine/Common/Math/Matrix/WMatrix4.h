...
public:
	...
	static Wvoid Shadow(/**/);
	static Wvoid Translation(WMatrix4& _out, WMatrix4& _in, WVector3 _position);
	static Wvoid Transpose(WMatrix4& _out, const WMatrix4& _in);

	// Specialization Functions
	void BuildIdentity();
	void BuildView(WVector3 _position, WVector3 _rotation, WVector3 _lookAt, WVector3 _up);												// OK - N
	...
	void BuildTransform(WVector3 _position, WVector3 _rotation, WVector3 _size);
