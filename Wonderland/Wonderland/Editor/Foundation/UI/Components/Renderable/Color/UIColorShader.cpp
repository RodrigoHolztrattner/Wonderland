...
UIColorShader::UIColorShader()
{
}

UIColorShader::UIColorShader(const UIColorShader& other)
{
}
...
bool UIColorShader::PrepareToRender()
{
...
void UIColorShader::RenderAux(UIColorComponent* _object)
{
	unsigned int location;
