...
bool VulkanWrapper::VWTextureGroupManager::Initialize(VWContext* _graphicContext, HoardResourceIndexLoader<VWTextureGroupIndex>* _textureGroupIndexLoaderRef, uint32_t _totalWorkerThreads)
{
...
void VulkanWrapper::VWTextureGroupManager::ProcessTextureGroupRequestQueues(HoardResourceManager* _resourceManager)
{
...
void VulkanWrapper::VWTextureGroupManager::ProcessTextureGroupRequest(HoardResourceManager* _resourceManager, VWTextureGroupRequest& _textureGroupRequest)
{
