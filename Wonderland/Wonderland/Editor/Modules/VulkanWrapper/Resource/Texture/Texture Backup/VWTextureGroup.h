...
public: //////////
	...
	Reference::Blob<VulkanWrapper::HoardResource>* GetResourceReference() { return &m_ResourceReference; }
...
private: //////
	...
	Reference::Blob<VulkanWrapper::HoardResource> m_ResourceReference;
