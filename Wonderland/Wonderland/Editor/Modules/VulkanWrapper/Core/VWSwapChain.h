...
#include "..\Misc\VWBufferClear.h"
#include "..\Resource\VWImage.h"
...
public: //////////
	...
	void CreateDepthResources(VWGraphicInstance* _graphicInstance);
	...
	VWImage* GetDepthImage() { return &m_DepthImage; }
